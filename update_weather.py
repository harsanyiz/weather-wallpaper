...
def main():
    ...
    # Féláttetsző sáv bal alulra
    overlay = Image.new("RGBA", img.size, (0, 0, 0, 0))
    ov_draw = ImageDraw.Draw(overlay)
    ov_draw.rectangle([(0, 900), (700, 1080)], fill=(0, 0, 0, 140))
    ...
    draw.text((40, 920), f"{temp}°C  •  {weather_hu}", fill=(255, 255, 255))
    draw.text((40, 960), f"Érzet: {feels_like}°C  •  Pára: {humidity}%  •  Szél: {wind} km/h", fill=(200, 200, 200))
    draw.text((40, 1000), f"Budapest  •  {now_hu}", fill=(160, 160, 160))
