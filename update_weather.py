...
# ============================================================
# 4K KONFIGURÁCIÓ - JAVÍTOTT, EXTRA KICSI FŐ IKON
# ============================================================
CITY = "Budapest"
WIDGET_Y = 100        
OFFSET_LEFT = 135     
...
def main():
    ...
    # --- 1. SZEKCIÓ: FŐ IKON (JAVÍTOTT, KICSINYÍTETT MÉRET) + HŐFOK + ÁLLAPOT AZ IKON ALATT ---
    icon_path = f"images/PNG/{icon_file}.png"
    if os.path.exists(icon_path):
        icon_img = Image.open(icon_path).convert("RGBA")
        # JAVÍTÁS: A fő ikont még kisebbre (100x100), hogy finomabb legyen a letisztult designhoz
        ...
        curr_x += 140 # Kevesebb helyet foglal, így a szöveg még közelebb kerül
