...
# Tipográfia - Apple-stílusú hierarchia
FONT_TEMP     = 105  # Domináns fő hőmérséklet
FONT_HEADER   = 24   # Elegáns fejléc
FONT_VALUE    = 36   # Adat értékek
FONT_SMALL    = 34   # Érzet hőfok
FONT_DATETIME = 24
FONT_NAME     = 28
...
WIND_ICON_SIZE     = 36
PARA_ICON_SIZE     = 36
FORECAST_ICON_SIZE = 58   # Megnövelt ikonok a jobb láthatóságért
SUN_ICON_SIZE      = 40
...
def draw_weather_widget(img, weather, icon_img, feel_icon_img,
    ...
    main_w = ICON_DISPLAY_SIZE + 40 + t_w + 35 + FEEL_ICON_SIZE + 12 + f_w
    ...
    # --- PIXEL PERFECT BASELINE IGAZÍTÁS ---
    base_line_y = temp_y + t_h
    feel_x = tx + t_w + 35
    if feel_icon_img:
        paste_icon(img, feel_icon_img, feel_x, base_line_y - FEEL_ICON_SIZE - 4, size=FEEL_ICON_SIZE)
